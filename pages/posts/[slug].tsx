  ...
  return (
    <main>
      ...
      {submitted ? (
        ...
        >
          <h3 className='text-sm text-yellow-500'>Enjoyed this articke ?</h3>
          ...
          <label className='block mb-5' htmlFor=''>
            ...
            <textarea
              ...
              className='shadow form-textarea border rounded py-2 px-3 mt-1 block w-full ring-yellow-500 outline-none focus:ring '
